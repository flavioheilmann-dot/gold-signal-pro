...
const WATCHLIST = [
  ...
  { epic: "US500", name: "S&P 500", kind: "index" },
  { epic: "GOLD", name: "Gold", kind: "metal" },
  { epic: "US100", name: "Nasdaq 100", kind: "index" },
  { epic: "DE40", name: "DAX 40", kind: "index" },
  { epic: "FR40", name: "CAC 40", kind: "index" },
  { epic: "UK100", name: "FTSE 100", kind: "index" },
  { epic: "JP225", name: "Nikkei 225", kind: "index" },
  { epic: "HK50", name: "Hang Seng", kind: "index" },
  { epic: "EU50", name: "Euro Stoxx 50", kind: "index" },
  ...
  { epic: "SILVER", name: "Silber", kind: "metal" },
  { epic: "PLATINUM", name: "Platin", kind: "metal" },
  { epic: "OIL_CRUDE", name: "Öl (WTI)", kind: "commodity" },
  { epic: "NATURALGAS", name: "Erdgas", kind: "commodity" },
  { epic: "BTCUSD", name: "Bitcoin", kind: "crypto" },
  { epic: "ETHUSD", name: "Ethereum", kind: "crypto" },
  { epic: "SOLUSD", name: "Solana", kind: "crypto" },
  { epic: "AAPL", name: "Apple", kind: "stock" },
  { epic: "NVDA", name: "Nvidia", kind: "stock" },
  { epic: "MSFT", name: "Microsoft", kind: "stock" },
  { epic: "TSLA", name: "Tesla", kind: "stock" },
  { epic: "AMZN", name: "Amazon", kind: "stock" },
  { epic: "GOOGL", name: "Google", kind: "stock" },
  { epic: "META", name: "Meta", kind: "stock" },
  { epic: "AMD", name: "AMD", kind: "stock" },
  { epic: "NFLX", name: "Netflix", kind: "stock" },
  { epic: "JPM", name: "JPMorgan", kind: "stock" },
  { epic: "V", name: "Visa", kind: "stock" },
  { epic: "BA", name: "Boeing", kind: "stock" },
];
